...
private:
    // хранение внутренних данных о документе (рейтинг и статус)
...
Большинство людей интересуется только актуальной информацией. Поэтому неясно, зачем просить пользователя поисковой системы каждый раз передавать статус. Научите метод FindTopDocuments обходиться одним аргументом — поисковым запросом. То есть поиск должен производиться только по актуальным документам.
