...
Теперь сделайте то же самое другим способом. Сделайте функцию ComputeAverageRating приватным статическим методом класса SearchServer. Перед возвращаемым значением функции добавьте ключевое слово static и перенесите саму функцию внутрь класса SearchServer. В отличие от обычных методов, static-методы не привязаны к объектам класса и не могут обращаться к полям. Здесь приватный статический метод — просто функция. Вызвать её можно только из методов класса. Не забудьте круглые скобки.
Формат ввода
