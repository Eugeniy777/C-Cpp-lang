...
int ComputeAverageRating(const vector<int> &ratings)
{
    ...
    return sredn_rating / (int)ratings.size();
}
...
Вы написали код поисковой системы. Теперь каждый документ на входе имеет набор оценок пользователей. Первая цифра — это количество оценок. Считайте их, передайте в AddDocument в виде вектора целых чисел и вычислите средний рейтинг документа, разделив суммарный рейтинг на количество оценок. Рейтинг документа, не имеющего оценок, равен нулю.
...
Код вычисления среднего рейтинга поместите в функцию ComputeAverageRating. Сигнатура этой функции представлена ниже. Используйте эту функцию, чтобы вычислить средний рейтинг документа в методе AddDocument.
